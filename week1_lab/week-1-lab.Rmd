...
rootdir <- "~/Users/ryangreen/Desktop/ /UCSB_MEDS/EDS_222_stats/EDS_222/week1_lab"
...
source(file.path("Course Materials","_common.R"))
...
loans_table %>%
  ...
  tab_spanner(columns = 2:4,
              label="homeownership") %>%
  tab_stubhead(label = "application_type") %>%
